...
const customControllers = {
  ...
  getCustomers: async (req, res) => {
    try {
      const data = await lookupService.getAllCustomer(req.query.client_id)
      res.send(
        new CommonMessage({
          data: data
        })
  ...
  getVendors: async (req, res) => {
    try {
      const data = await lookupService.getAllVendor(req.query.client_id)
      res.send(
        new CommonMessage({
          data: data
        })
  ...
  getInventory: async (req, res) => {
    try {
      const data = await lookupService.getAllItem(req.query.client_id)
      res.send(
        new CommonMessage({
          data: data
        })
